...
var ntipaMashupApp = angular.module('ntipaMashupApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'ntipaMashupAppUtils', 'pascalprecht.translate', 'truncate']);
